...
flight_assistant_prompt = ChatPromptTemplate.from_messages(
    [
        (
            ...
            ' call "WorkerCompleteOrEscalate" to pass dialog to the host assistant. Do not waste the user\'s time. Do not make up invalid tools or functions.'
            "If you believe you have completed the current task, call 'WorkerCompleteOrEscalate' to complete the dialog.",
        ),
